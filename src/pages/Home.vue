  ...
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside :width="collapseWidth">
        ...
        <el-menu background-color="#34495e" text-color="#fff" active-text-color="#ffd04b" unique-opened
          :collapse="isCollapse" :collapse-transition="false" router :default-active="navActive">
          <!-- 一级菜单 -->
